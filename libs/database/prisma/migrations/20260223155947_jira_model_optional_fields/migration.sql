...
INSERT INTO "new_jira_issue" ("assignee_email", "created_at", "epic_key", "id", "issue_type", "key", "parent_issue_key", "priority", "status", "summary", "updated_at") SELECT "assignee_email", "created_at", "epic_key", "id", "issue_type", "key", "parent_issue_key", "priority", "status", "summary", "updated_at" FROM "jira_issue";
